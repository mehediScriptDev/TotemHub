...
const Select = ({
  ...
  const baseSelectClasses = isLight
    ? 'w-full rounded-xl bg-white border text-surface-800 transition-all duration-200 focus-ring text-sm px-4 py-2.5 cursor-pointer appearance-none'
    : 'w-full rounded-xl bg-surface-800/80 border text-surface-100 transition-all duration-200 focus-ring text-sm px-4 py-2.5 cursor-pointer appearance-none';
